...
insert into mentors(mentor_name, mentor_email) values('zen1','zen1@guvi.com');
insert into mentors(mentor_name, mentor_email) values('zen2','zen2@guvi.com');
insert into mentors(mentor_name, mentor_email) values('zen3','zen3@guvi.com');
insert into mentors(mentor_name, mentor_email) values('zen4','zen4@guvi.com');
insert into mentors(mentor_name, mentor_email) values('zen5','zen5@guvi.com');
...
insert into courses(course_name, completion_time_hrs) values('react',8);
insert into courses(course_name, completion_time_hrs) values('nodejs',10);
...
insert into users(email, username, password, first_name, last_name, gender, dob, mentor_id) values ('piyush@gmail.com','piyush123','pass@123','Piyush','Guvi','Male','1999-03-30',1);
insert into users(email, username, password, first_name, last_name, gender, dob, mentor_id) values ('vyas@gmail.com','vyas123','pass@123','Vyas','Guvi','Male','1999-03-30',2);
insert into users(email, username, password, first_name, last_name, gender, dob, mentor_id) values ('rohit@gmail.com','rohit123','pass@123','Rohit','Guvi','Male','1998-08-12',4);
insert into users(email, username, password, first_name, last_name, gender, dob, mentor_id) values ('agrawal@gmail.com','agrawal123','pass@123','Agrawal','Guvi','Male','1998-01-21',1);
insert into users(email, username, password, first_name, last_name, gender, dob, mentor_id) values ('pooja@gmail.com','pooja123','pass@123','Pooja','Guvi','Female','1998-10-06',1);
insert into users(email, username, password, first_name, last_name, gender, dob, mentor_id) values ('thorat@gmail.com','thorat123','pass@123','Thorat','Guvi','Male','1998-02-15',3);
insert into users(email, username, password, first_name, last_name, gender, dob, mentor_id) values ('yatharth@gmail.com','yatharth123','pass@123','Yatharth','Guvi','Male','1998-10-22',2);
insert into users(email, username, password, first_name, last_name, gender, dob, mentor_id) values ('anand@gmail.com','anand123','pass@123','Anand','Guvi','Male','1998-03-22',3);
